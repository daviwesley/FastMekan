...
public class TelaCadastroUsuario extends Shell {
	private Text text;
	private Text text_1;
	private Combo combo;
	 ...
	 * @param display
	 */
	public TelaCadastroUsuario(Display display) {
		super(display, SWT.SHELL_TRIM);
		setImage(SWTResourceManager.getImage(TelaCadastroUsuario.class, "/toolbar/mechanic.png"));
		...
		btnNewButton.setImage(SWTResourceManager.getImage(TelaCadastroUsuario.class, "/toolbar/plussmall.png"));
		...
		lblNomeDoUsuario = new Label(this, SWT.NONE);
		FormData fd_lblNomeDoUsuario = new FormData();
		fd_lblNomeDoUsuario.top = new FormAttachment(lblSenha, 16);
		fd_lblNomeDoUsuario.left = new FormAttachment(lblNomeCompleto, 0, SWT.LEFT);
		lblNomeDoUsuario.setLayoutData(fd_lblNomeDoUsuario);
		lblNomeDoUsuario.setText("Nome do Usuario");
		
		text_6 = new Text(this, SWT.BORDER);
		FormData fd_text_6 = new FormData();
		fd_text_6.right = new FormAttachment(lblNomeDoUsuario, 127, SWT.RIGHT);
		fd_text_6.top = new FormAttachment(text_4, 6);
		fd_text_6.left = new FormAttachment(lblNomeDoUsuario, 2);
		text_6.setLayoutData(fd_text_6);
		
		lblNewLabel_2 = new Label(this, SWT.NONE);
		FormData fd_lblNewLabel_2 = new FormData();
		fd_lblNewLabel_2.bottom = new FormAttachment(lblNomeDoUsuario, 0, SWT.BOTTOM);
		fd_lblNewLabel_2.left = new FormAttachment(text_6, 11);
		...
		fd_text_7.left = new FormAttachment(lblNewLabel_2, 5);
		fd_text_7.top = new FormAttachment(text_4, 6);
		text_7.setLayoutData(fd_text_7);
		
		lblNewLabel_3 = new Label(this, SWT.NONE);
		fd_btnNewButton.top = new FormAttachment(lblNewLabel_3, 25);
		FormData fd_lblNewLabel_3 = new FormData();
		lblNewLabel_3.setLayoutData(fd_lblNewLabel_3);
		lblNewLabel_3.setText("Confirmar senha");
		
		text_8 = new Text(this, SWT.BORDER | SWT.PASSWORD);
		fd_lblNewLabel_3.right = new FormAttachment(text_8, -6);
		fd_btnNewButton_1.top = new FormAttachment(text_8, 22);
		fd_lblNewLabel_3.top = new FormAttachment(text_8, 3, SWT.TOP);
		FormData fd_text_8 = new FormData();
		fd_text_8.right = new FormAttachment(100, -10);
		fd_text_8.left = new FormAttachment(0, 281);
		...
		fd_infoLabel.left = new FormAttachment(0, 189);
		fd_infoLabel.top = new FormAttachment(89);
		fd_infoLabel.right = new FormAttachment(100, -190);
