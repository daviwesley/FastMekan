...
public class TelaCadastroCliente extends Shell {
	private Text text;
	private Text text_1;
	private Combo combo;
	 ...
	 * @param display
	 */
	public TelaCadastroCliente(Display display) {
		super(display, SWT.SHELL_TRIM);
		setImage(SWTResourceManager.getImage(TelaCadastroCliente.class, "/toolbar/mechanic.png"));
		...
		btnNewButton.setImage(SWTResourceManager.getImage(TelaCadastroCliente.class, "/toolbar/plussmall.png"));
		...
		setTabList(new Control[]{text, text_1, combo, text_2, text_3, text_4, btnNewButton, btnNewButton_1, text_5});
